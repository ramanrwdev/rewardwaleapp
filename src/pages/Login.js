...
<View style={{marginBottom:normalizeHeight(20)}}>
  ...
  <CmpTextBox
                 // value={fields.guardianname ? fields.guardianname : ''}
                  ...
                  label={'Login with Email, Mobile Number or Username'}
                  value={email}
                  placeholder={'Login with Email, Mobile Number or Username'}
...
<CmpTextBox
                 // value={fields.guardianname ? fields.guardianname : ''}
                  ...
                  authoCapitalize="none"
                  textPrefix={''}
                  imageSourceSuffix={passwordshow ? images.eye_close:images.eye_open}
                  maxLength={50}
                  ...
                  errorMessage={
                    errorspassword && errorspassword ? errorspassword : ''
                  }

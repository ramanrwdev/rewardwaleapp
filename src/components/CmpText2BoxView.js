...
const CmpText2BoxView = (props) => {
    ...
    return (
        <View pointerEvents={!onPress && editable === false ? 'none' : 'auto'} style={{marginTop:0}}>
            ...
            <Text style={[GlobalStyles.errorstyle, { paddingBottom: normalizeHeight(0) }]}>{errorMessage ? errorMessage : '  '}</Text>
        </View>
    );
}
...
const styles = StyleSheet.create({
    ...
    label: { flexDirection: 'row', alignItems: 'center', paddingBottom: normalizeHeight(0) },
    textinside: {
...
export default CmpText2BoxView 